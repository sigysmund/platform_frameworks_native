...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(SPEC_TV),
    DEFINE_KEYCODE(SPEC_HOTEL),
    DEFINE_KEYCODE(SPEC_ROOM),
    DEFINE_KEYCODE(SPEC_SHOP),
    DEFINE_KEYCODE(SPEC_SPECIAL),
    DEFINE_KEYCODE(SPEC_MOVIE),
    DEFINE_KEYCODE(SPEC_MUSIC),
    DEFINE_KEYCODE(SPEC_GAMES),
    DEFINE_KEYCODE(SPEC_MESSAGES),
    DEFINE_KEYCODE(SPEC_INFO),
    DEFINE_KEYCODE(SPEC_EPG),
